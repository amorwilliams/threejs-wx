...
export default class UI {
  ...
  initRanking() {
    ...
    const geometry = new THREE.PlaneGeometry(GameParams.width, GameParams.height)

    const material = new THREE.MeshBasicMaterial({ map: this.rankingTexture, transparent: true })
